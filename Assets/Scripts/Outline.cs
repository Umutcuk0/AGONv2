...
public class Outline : MonoBehaviour
{
    ...
    void Awake()
    {
        // --- KESİN ÇÖZÜM NOKTASI 1: RAM TEMİZLİĞİ ---
        // Unity'nin statik hafızasında asılı kalan bozuk meshleri siliyoruz ki kodumuz pas geçilmesin!
    ...
    void LoadSmoothNormals()
    {
        ...
        // --- KESİN ÇÖZÜM NOKTASI 2: ANİMASYONLU KARAKTER DÜZELTMESİ ---
        // UV kanallarını sıfırlayan eski buggy kodu sildik, jilet gibi çalışan UV3 hesaplamasını getirdik.
